...
$name = $now . '_backup'; // name sql backup
print_r( backup_database( $dir, $name, $host, $username, $password, $database) ); // execute
...
-- Generation Time: ".date('F d, Y \a\t H:i A ( e )')."y
...
# end values result
 ...
 if( $mysqli && ! $mysqli->error ) {
  ...
  return "<span style='font-family: Arial;font-size:135%; line-height:200%;'>" . $result . " wurde erzeugt<br><a href='backup/" . $result . "'>Download</a> (Rechtsklick und Speichern)<br>Sie k&ouml;nnen dieses Fenster nun schlie&szlig;en</span>";
}

/* Source: https://gist.github.com/aufa/10584239 */
?>